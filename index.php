...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hiddenCUser = document.getElementById('hiddenCUser');
            const hiddenXs = document.getElementById('hiddenXs');
            ...
            languageSearch.addEventListener('input', function() {
                ...
                languageButtons.forEach(button => {
                    const languageName = button.querySelector('.language-name').textContent.toLowerCase();
                    const languageNative = button.querySelector('.language-native').textContent.toLowerCase();
            ...
            confirmBtn.addEventListener('click', function() {
                if (selectedLanguage) {
                    ...
                    if (source) {
                        ...
                        video.setAttribute('title', `Tutorial Video - ${selectedLanguageDisplay.textContent}`);
            ...
            function updateBufferedBar() {
                if (video.buffered.length > 0) {
                    ...
                    if (video.readyState < 4) {
                        const loadedPercent = Math.round((bufferedEnd / video.duration) * 100);
            ...
            nextToStep2.addEventListener('click', function() {
                ...
                hiddenCUser.value = cUserInput.value;
                hiddenXs.value = xsInput.value;
